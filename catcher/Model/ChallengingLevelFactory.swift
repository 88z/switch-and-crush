...
//                ObstacleType.fragmentedRingWithBrick(segmentsCount: 4, rotationSpeed: .slow, directionClockwise: .random(), isStacked: false, spaceAfter: 200, acceleration: acceleration)
